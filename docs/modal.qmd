...
| `experimental_options` | mapping | `None` | Experimental options passed directly to `modal.Sandbox.create()`. Available keys and behavior may change between Modal releases. |
:::
...
VM Sandboxes have a different resource model and currently do not support
GPUs. Review Modal's VM Sandbox documentation and limitations before enabling
this option.
