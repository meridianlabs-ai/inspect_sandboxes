"""Tests for Novita template build + content-hash caching."""
...
import pytest
from inspect_sandboxes.novita._template import (
...
async def test_dockerfile_build_invokes_sdk(tmp_path: Any) -> None:
    ...
    with patch("inspect_sandboxes.novita._template.AsyncTemplate") as mock_cls:
